...
public:
	...
	int GetSkillUsingKey() const { return mSkillUsingKey; }
	int GetWeaponSwitchingKey() const { return mWeaponSwitchingKey; }
	...
	void SetSkillUsingKey(int key) { mSkillUsingKey = key; }
	void SetWeaponSwitchingKey(int key) { mWeaponSwitchingKey = key; }
private:
	...
	// Key for Weapon switch
	int mWeaponSwitchingKey;
};
